...
public class StealthSkill extends Skill {
    ...
    public static class StealthEventHandler {
        @SubscribeEvent
        public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
            if (!(event.player instanceof ServerPlayer serverPlayer)) return;
            if (!(PlayerSkillManager.getSkillInstance(serverPlayer, SkillRegistry.STEALTH.getSkillId()) instanceof StealthSkill stealthSkill)) return;
