...
public class ShrapnelBarrageData extends SkillData {
    public ShrapnelBarrageData() {
        super(
                ...
                "Shrapnel Barrage",
                (level) -> String.format("Inflict %.0f%% of the damage dealt to nearby enemies when striking a §lMarked§l target with a projectile.", toPercent(ShrapnelBarrageSkill.getDamageMultiplier(level))),
