package me.cat.skilled.skill.instance.generic;
...
public class BarrierSkill extends Skill {
    ...
    public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
        if (event.player instanceof ServerPlayer serverPlayer && SkillUtil.getSkillInstance(serverPlayer, SkillRegistry.BARRIER.getSkillId()) instanceof BarrierSkill barrierSkill) {
